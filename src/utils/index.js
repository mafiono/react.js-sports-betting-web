...
const emailRegex =  /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-z]{2,}))$/
    ,phoneRegex= /^0(2)(0|3|4|6|7)\d{3}\d{4}|0(5)(0|4|5|6|7|9)\d{3}\d{4}|(5)(0|4|5|6|7|9)\d{3}\d{4}|(2)(0|3|4|6|7)\d{3}\d{4}$/
      ,full_nameRegex=/^[a-z A-Z +,.'-]{2,}$/,passwordReqex = /^[0-9a-zA-Z]{8,}$/,usernameRegex = /^[0-9 a-z A-Z,.'-]{6,}$/,SMSRegex=/^[0-9a-zA-Z]{6,}$/,onlyMoney=/^[0-9]+(\.[0-9]{1,2})?$/;
