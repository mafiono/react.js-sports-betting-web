  ...
  function l(c, d) {
    ...
    switch (d) {
      case "decimal":
        ...
        e = b.main.decimalFormatRemove3Digit ? (a.mathCuttingFunction(100 * e) / 100).toFixed(b.main.roundDecimalCoefficients) : g !== e && c.toString().split(".")[1] && 2 < c.toString().split(".")[1].length ? Math.round(c * Math.pow(10, b.main.roundDecimalCoefficients)) / Math.pow(10, b.main.roundDecimalCoefficients) : e.toFixed(2);
...
export  function setCookie(name,value,path,expires=null) {
  if(void 0 !== name  && null !== name){
    ...
    console.log('indefined param name')
  }
}
