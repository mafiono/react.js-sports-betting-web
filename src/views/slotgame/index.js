...
export default class SlotGames extends PureComponent{
    constructor(props){
        super(props)
    ...
    render(){
         const{history,loadMarkets,addEventToSelection,sendRequest,GamesBanner}=this.props,{loadingMore,loadingGames,games,providers,categories,hidePro,game,wantToPlay,activeCat,activePro,keyword}=this.state
          return(
                ...
                <div className="sportsbook-view">
                    <div className="sportsbook-content">
                        <div className="event-view col-sm-12">
                            <div className="slot-game-view col-sm-10">
